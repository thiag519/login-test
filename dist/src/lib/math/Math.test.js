...
describe.skip('Testing Math library', () => {
    ...
    it('should sum two numbers correctly', () => {
        const response = Math_1.Math.sum(10, 5);
        expect(response).toBe(15);
    });
    it('should subtract two numbers correctly', () => {
        const response = Math_1.Math.sub(4, 2);
        expect(response).toBe(2);
    });
    it('should multiply two numbers correctly', () => {
        const response = Math_1.Math.mut(3, 5);
        expect(response).toBe(15);
    });
    it('should divide two numbers correctly', () => {
        const response = Math_1.Math.div(15, 5);
        expect(response).toBe(3);
        const response2 = Math_1.Math.div(3, 0);
